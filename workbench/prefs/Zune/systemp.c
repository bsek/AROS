...
ZUNE_CUSTOMCLASS_1(BubbleSlider, NULL, MUIC_Slider, NULL, MUIM_Numeric_Stringify, struct MUIP_Numeric_Stringify *)
...
LONG PopPublicScreenStrObjFunc(struct Hook *hook, Object *popup, Object *str) {
    ...
    ForeachNode(pubscrlist, pubscrnode) { DoMethod(data->list, MUIM_List_InsertSingle, (IPTR)pubscrnode->psn_Node.ln_Name, MUIV_List_Insert_Bottom); }
    UnlockPubScreenList();
...
IPTR PopPublicScreen__OM_NEW(struct IClass *cl, Object *obj, struct opSet *msg) {
    ...
    obj = (Object *)DoSuperNewTags(
        cl, obj, NULL, MUIA_Popobject_Object,
        (IPTR)(lv = (Object *)ListviewObject, MUIA_Listview_List, (IPTR)(list = (Object *)ListObject, InputListFrame, End), End), TAG_MORE,
    ...
    if (obj) {
        ...
        SetAttrs(obj, MUIA_Popobject_StrObjHook, (IPTR)&data->strobj_hook, MUIA_Popobject_ObjStrHook, (IPTR)&data->objstr_hook, TAG_DONE);
...
ZUNE_CUSTOMCLASS_1(PopPublicScreen, NULL, MUIC_Popobject, NULL, OM_NEW, struct opSet *)
...
struct MUI_SystemPData {
    ...
    Object *dirtyregion_checkmark;
    struct Hook psiHook;
};

static IPTR ExecuteScreenInspectorFunc(struct Hook *hook, Object *caller, void *data) {
    struct TagItem tags[] = {{SYS_Asynch, TRUE}, {SYS_Input, 0}, {SYS_Output, 0}, {NP_StackSize, AROS_STACKSIZE}, {TAG_DONE}};
...
static IPTR SystemP_New(struct IClass *cl, Object *obj, struct opSet *msg) {
    ...
    obj = (Object *)DoSuperNewTags(
        ...
        Child, (IPTR)ColGroup(2), MUIA_Group_SameSize, TRUE,

        Child, (IPTR)VGroup, GroupFrameT(_(MSG_PUBLIC_SCREEN)), MUIA_Group_VertSpacing, 0, Child, (IPTR)VSpace(0), Child, (IPTR)ColGroup(2), Child,
        (IPTR)Label1(_(MSG_NAME)), Child,
        NewObject(PopPublicScreen_CLASS->mcc_Class, NULL, MUIA_Popstring_String,
                  (IPTR)(d.screen_name_string = StringObject, MUIA_Frame, MUIV_Frame_String, End), MUIA_Popstring_Button, PopButton(MUII_PopUp),
                  TAG_END),
        Child, HSpace(0), Child, (IPTR)(d.call_psi_button = SimpleButton(_(MSG_CALL_INSPECTOR))), Child, (IPTR)Label1(_(MSG_POP_TO_FRONT)), Child,
        HGroup, Child, (IPTR)(d.pop_to_front_checkmark = MakeCheck(NULL)), Child, RectangleObject, End, End, End, Child, (IPTR)VSpace(0), End,

        Child, (IPTR)VGroup, GroupFrameT(_(MSG_ICONIFICATION)), MUIA_Group_VertSpacing, 0, Child, (IPTR)VSpace(0), Child, (IPTR)ColGroup(2), Child,
        (IPTR)Label1(_(MSG_HOTKEY)), Child, (IPTR)(d.hotkey_string = MakeString()), Child, (IPTR)Label1(_(MSG_SHOW)), Child, HGroup, Child,
        (IPTR)(d.show_icon_checkmark = MakeCheck(NULL)), Child, (IPTR)Label1(_(MSG_ICON)), Child, (IPTR)(d.show_menu_checkmark = MakeCheck(NULL)),
        Child, (IPTR)Label1(_(MSG_MENU)), End, Child, (IPTR)Label1(_(MSG_ON_STARTUP)), Child, HGroup, Child,
        (IPTR)(d.on_startup_checkmark = MakeCheck(NULL)), Child, RectangleObject, End, End, End, Child, (IPTR)VSpace(0), End,

        Child, (IPTR)VGroup, GroupFrameT(_(MSG_INTERFACES)), MUIA_Group_VertSpacing, 0, Child, (IPTR)VSpace(0), Child, (IPTR)HGroup, Child, HSpace(0),
        Child, (IPTR)Label1(_(MSG_AREXX)), Child, (IPTR)(d.arexx_checkmark = MakeCheck(NULL)), Child, HSpace(0), End, Child, (IPTR)VSpace(0), End,

        Child, (IPTR)VGroup, GroupFrameT(_(MSG_BUBBLE_HELP)), MUIA_Group_VertSpacing, 0, Child, (IPTR)VSpace(0), Child, (IPTR)ColGroup(2), Child,
        (IPTR)Label1(_(MSG_FIRST_BUBBLE)), Child,
        (IPTR)(d.first_bubble_slider = NewObject(BubbleSlider_CLASS->mcc_Class, NULL, MUIA_Numeric_Min, 0, MUIA_Numeric_Max, 50, TAG_END)), Child,
        (IPTR)Label1(_(MSG_NEXT_BUBBLE)), Child,
        (IPTR)(d.next_bubble_slider = NewObject(BubbleSlider_CLASS->mcc_Class, NULL, MUIA_Numeric_Min, 0, MUIA_Numeric_Max, 50, TAG_END)), End,

        End, /* ColGroup(2) */

        Child, (IPTR)VGroup, GroupFrameT("Renderer"), MUIA_Group_VertSpacing, 0, Child, (IPTR)VSpace(0), Child, (IPTR)HGroup, Child, HSpace(0), Child,
        (IPTR)Label1("Anti-aliasing"), Child, (IPTR)(d.antialias_checkmark = MakeCheck(NULL)), Child, HSpace(0), End, Child, (IPTR)HGroup, Child,
        HSpace(0), Child, (IPTR)Label1("Double buffering"), Child, (IPTR)(d.doublebuffer_checkmark = MakeCheck(NULL)), Child, HSpace(0), End, Child,
        (IPTR)HGroup, Child, HSpace(0), Child, (IPTR)Label1("Dirty region blitting"), Child, (IPTR)(d.dirtyregion_checkmark = MakeCheck(NULL)), Child,
        HSpace(0), End, Child, (IPTR)VSpace(0), End, Child, (IPTR)VSpace(0), End,
    ...
    *data = d;
    ...
    DoMethod(d.first_bubble_slider, MUIM_Notify, MUIA_Numeric_Value, MUIV_EveryTime, d.next_bubble_slider, (IPTR)3, MUIM_Set, MUIA_Disabled,
             MUIV_NotTriggerValue);

    DoMethod(d.call_psi_button, MUIM_Notify, MUIA_Pressed, FALSE, obj, (IPTR)2, MUIM_CallHook, &data->psiHook);

    return (IPTR)obj;
}

static IPTR SystemP_ConfigToGadgets(struct IClass *cl, Object *obj, struct MUIP_Settingsgroup_ConfigToGadgets *msg) {
    ...
    ConfigToCheckmark(msg->configdata, MUICFG_Renderer_DirtyRegion, data->dirtyregion_checkmark);

    return 1;
}

static IPTR SystemP_GadgetsToConfig(struct IClass *cl, Object *obj, struct MUIP_Settingsgroup_GadgetsToConfig *msg) {
    struct MUI_SystemPData *data = INST_DATA(cl, obj);
    ...
    CheckmarkToConfig(data->dirtyregion_checkmark, msg->configdata, MUICFG_Renderer_DirtyRegion);
...
BOOPSI_DISPATCHER(IPTR, SystemP_Dispatcher, cl, obj, msg) {
    switch (msg->MethodID) {
    case OM_NEW:
        return SystemP_New(cl, obj, (struct opSet *)msg);
    case MUIM_Settingsgroup_ConfigToGadgets:
        return SystemP_ConfigToGadgets(cl, obj, (APTR)msg);
        break;
    case MUIM_Settingsgroup_GadgetsToConfig:
        return SystemP_GadgetsToConfig(cl, obj, (APTR)msg);
        break;
    }
 ...
 * Class descriptor.
 */
const struct __MUIBuiltinClass _MUIP_System_desc = {"System", MUIC_Group, sizeof(struct MUI_SystemPData), (void *)SystemP_Dispatcher};

static const UBYTE icon32[] = {
    0x00, 0x00, 0x00, 0x18,                         // width
    0x00, 0x00, 0x00, 0x13,                         // height
    'B',  'Z',  '2',  '\0', 0x00, 0x00, 0x00, 0x6e, // number of bytes

    0x42, 0x5a, 0x68, 0x39, 0x31, 0x41, 0x59, 0x26, 0x53, 0x59, 0x26, 0xc3, 0xe9, 0x90, 0x00, 0x03, 0x0e, 0x06, 0x42, 0x80, 0x02, 0x00,
    0x01, 0x08, 0x00, 0x42, 0x40, 0x00, 0x00, 0xb0, 0x00, 0xb6, 0xc8, 0x42, 0x54, 0xc9, 0x82, 0x92, 0xa1, 0x90, 0x42, 0xa6, 0x9a, 0x3a,
    0x2a, 0xdb, 0x65, 0x78, 0xa8, 0x34, 0xa5, 0xea, 0x52, 0xe1, 0x49, 0xd2, 0x44, 0xc1, 0x51, 0x3d, 0xa9, 0x33, 0x43, 0x43, 0x4a, 0xad,
    0x15, 0x30, 0x41, 0x40, 0xf7, 0x23, 0x22, 0x44, 0x50, 0x81, 0x2b, 0x08, 0x18, 0x58, 0x95, 0xa7, 0x41, 0x8b, 0x24, 0x50, 0x60, 0x97,
    0x13, 0xa0, 0xd1, 0x42, 0x0d, 0x52, 0x86, 0x20, 0x62, 0x6c, 0x08, 0xf8, 0xbb, 0x92, 0x29, 0xc2, 0x84, 0x81, 0x36, 0x1f, 0x4c, 0x80,
};

Object *systemclass_get_icon(void) { return RawimageObject, MUIA_Rawimage_Data, icon32, End; }
