...
#ifndef ZUNERENDERER_INTERN_H
#define ZUNERENDERER_INTERN_H
...
#define ZRB(base) ((struct IntZuneRendererBase *)(base))
...
/* Texture management */
void AddTextureToList(struct IntZuneRendererBase *base,
                      struct ZuneTexture *texture);
void RemoveTextureFromList(struct IntZuneRendererBase *base,
                           struct ZuneTexture *texture);
