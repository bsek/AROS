...
#define MUIM_Window_AddControlCharHandler /* PRIV */ (MUIB_Window | 0x00000000) /* Zune: V1, PRIV don't use it! */
#define MUIM_Window_AllocGadgetID                                                                                                                    \
    (MUIB_Window | 0x00000001)                                           /* Zune: V1 - allocate a GadgetID for                                       \
                                                                          * BOOPSI gadgets */
#define MUIM_Window_DrawBackground /* PRIV */ (MUIB_Window | 0x00000002) /* Zune: V1 - like MUIM_DrawBackground but PRIV */
#define MUIM_Window_DragObject /* PRIV */ (MUIB_Window | 0x00000003)     /* Zune: V1, PRIV don't use it! */
#define MUIM_Window_FreeGadgetID                                                                                                                     \
    (MUIB_Window | 0x00000004)                                                  /* Zune: V1 - free the GadgetID for                                  \
                                                                                 * BOOPSI gadgets */
#define MUIM_Window_RecalcDisplay /* PRIV */ (MUIB_Window | 0x00000005)         /* Zune: V1, PRIV don't use it! */
#define MUIM_Window_RemControlCharHandler /* PRIV */ (MUIB_Window | 0x00000006) /* Zune: V1, PRIV don't use it! */
#define MUIM_Window_UpdateMenu /* PRIV */ (MUIB_Window | 0x00000007)            /* Zune: V1, PRIV don't use it! */
#define MUIM_Window_Refresh /* PRIV */ (MUIB_Window | 0x00000008)               /* Zune: V1, PRIV don't use it! */
...
#define MUIA_Window_DoubleBuffer (MUIB_Window | 0x00000004) /* Zune only i.. BOOL (default: FALSE) */
...
#define MUI_EHF_GUIMODE                                                                                                                              \
    (1 << 1)                          /* handler will not be called if object                                                                        \
