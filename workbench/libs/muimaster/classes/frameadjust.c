...
static Object *MakeFrameDisplay(int i, int state) {
  ...
  obj = MUI_NewObject(MUIC_Framedisplay,
                      //                      MUIA_FixWidth, 12,
                      //                      MUIA_FixHeight, 12,
                      ButtonFrame, InnerSpacing(6, 6), MUIA_Background,
...
IPTR Frameadjust__OM_NEW(struct IClass *cl, Object *obj, struct opSet *msg) {
  ...
  obj = (Object *)DoSuperNewTags(
      ...
      MUIA_Group_Horiz, TRUE, MUIA_Group_HorizSpacing, 20,

      Child,
      (IPTR)(FD_display =
                 MUI_NewObject(MUIC_Framedisplay, MUIA_FixWidth, 32, TAG_DONE)),
      Child, (IPTR)VGroup, MUIA_Group_VertSpacing, 10, Child, (IPTR)VGroup,
      GroupFrameT("Rounded Frame Options"), Child,
      (IPTR)(rounded_check =
                 MUI_MakeObject(MUIO_Checkmark, (IPTR) "Use Rounded Frame")),
      Child, (IPTR)ColGroup(4), Child, (IPTR)Label("Radius:"), Child,
      (IPTR)(radius_slider = MakeRoundedSlider(0, 15, 5)), Child,
      (IPTR)Label("Width:"), Child,
      (IPTR)(width_slider = MakeRoundedSlider(1, 15, 1)), End, End, Child,
      (IPTR)(GR_fd = (Object *)RowGroup(2), End),         /* RowGroup */
      Child, (IPTR)(GR_fd1 = (Object *)RowGroup(2), End), /* RowGroup */
      Child, (IPTR)(GR_fd2 = (Object *)RowGroup(2), End), /* RowGroup */
      Child, (IPTR)HGroup, Child, (IPTR)Label(_(MSG_FRAMEADJUST_INNER_SPACING)),
      Child, (IPTR)RowGroup(2), Child, (IPTR)Label2(_(MSG_FRAMEADJUST_LEFT)),
      Child, (IPTR)(SL_left = MakeSpacingSlider()), Child, (IPTR)HSpace(8),
      Child, (IPTR)Label2(_(MSG_FRAMEADJUST_TOP)), Child,
      (IPTR)(SL_top = MakeSpacingSlider()), Child,
      (IPTR)Label2(_(MSG_FRAMEADJUST_RIGHT)), Child,
      (IPTR)(SL_right = MakeSpacingSlider()), Child, (IPTR)HSpace(8), Child,
      (IPTR)Label2(_(MSG_FRAMEADJUST_BOTTOM)), Child,
      (IPTR)(SL_bottom = MakeSpacingSlider()), End, /* RowGroup */
      End,                                          /* HGroup */
      End,                                          /* VGroup */
