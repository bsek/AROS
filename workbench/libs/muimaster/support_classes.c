...
static const struct __MUIBuiltinClass *const builtins[] = {
    ...
    ZUNE_GAUGE_DESC ZUNE_ABOUTMUI_DESC ZUNE_SETTINGSGROUP_DESC
        ZUNE_IMAGEADJUST_DESC ZUNE_POPIMAGE_DESC ZUNE_SCALE_DESC ZUNE_RADIO_DESC
            ZUNE_ICONLISTVIEW_DESC ZUNE_BALANCE_DESC ZUNE_COLORFIELD_DESC
                ZUNE_COLORADJUST_DESC ZUNE_IMAGEDISPLAY_DESC
                    ZUNE_PENDISPLAY_DESC ZUNE_PENADJUST_DESC ZUNE_POPPEN_DESC
                        &_MUI_Mccprefs_desc,
    ZUNE_FRAMEDISPLAY_DESC ZUNE_POPFRAME_DESC ZUNE_FRAMEADJUST_DESC
        ZUNE_VOLUMELIST_DESC ZUNE_DIRLIST_DESC ZUNE_NUMERICBUTTON_DESC
            ZUNE_POPLIST_DESC ZUNE_CRAWLING_DESC ZUNE_POPSCREEN_DESC
                ZUNE_LEVELMETER_DESC ZUNE_KNOB_DESC ZUNE_DTPIC_DESC
                    ZUNE_PALETTE_DESC ZUNE_PANEL_DESC ZUNE_PANELGROUP_DESC};
...
/**************************************************************************/
static Class *ZUNE_FindBuiltinClass(ClassID classid,
                                    struct Library *MUIMasterBase) {
  struct MUIMasterBase_intern *intZuneBase =
      (struct MUIMasterBase_intern *)MUIMasterBase;
  Class *cl = NULL, *cl2;
...
#ifdef __AROS__
AROS_UFH3(IPTR, metaDispatcher, AROS_UFHA(struct IClass *, cl, A0),
          AROS_UFHA(Object *, obj, A2), AROS_UFHA(Msg, msg, A1)) {
  AROS_USERFUNC_INIT

  return AROS_UFC4(IPTR, cl->cl_Dispatcher.h_SubEntry,
                   AROS_UFPA(Class *, cl, A0), AROS_UFPA(Object *, obj, A2),
...
__asm ULONG metaDispatcher(register __a0 struct IClass *cl,
  ...
  __asm ULONG (*entry)(register __a0 struct IClass *cl,
                       register __a2 Object *obj, register __a1 Msg msg) =
      (__asm ULONG (*)(register __a0 struct IClass *, register __a2 Object *,
