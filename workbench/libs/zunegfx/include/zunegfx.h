...
/*****************************************************************************/
/* Layer Compositor - Hardware-accelerated window compositing */
/*****************************************************************************/
...
struct LayerCompositor *CreateLayerCompositor(struct Screen *screen);
struct LayerCompositor *CreateLayerCompositorShared(struct Screen *screen,
                                                     APTR masterGLContext);
void DestroyLayerCompositor(struct LayerCompositor *comp);
BOOL ActivateLayerCompositor(struct LayerCompositor *comp);
void DeactivateLayerCompositor(struct LayerCompositor *comp);

/* Window registration */
struct CompositorWindow *CompositorRegisterWindow(
    struct LayerCompositor *comp,
    struct Window *window,
    APTR glContext,
    struct DrawingBoard *board,
    UBYTE alpha);
void CompositorUnregisterWindow(struct LayerCompositor *comp,
                                 struct Window *window);
void CompositorSetWindowAlpha(struct LayerCompositor *comp,
                               struct Window *window,
                               UBYTE alpha);
void CompositorMarkWindowDirty(struct LayerCompositor *comp,
                                struct Window *window);
struct CompositorWindow *CompositorFindWindow(struct LayerCompositor *comp,
                                               struct Window *window);

/* Compositing */
void CompositorUpdate(struct LayerCompositor *comp);
void CompositorRefresh(struct LayerCompositor *comp);
void CompositorSetShadow(struct LayerCompositor *comp,
