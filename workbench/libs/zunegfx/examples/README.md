...
```bash
mmake workbench-libs-zunegfx-examples-simple_demo
mmake workbench-libs-zunegfx-examples-simplified_batching_example  
mmake workbench-libs-zunegfx-examples-simplified_drawingboard_example
```
...
- **zunegfx.library**: The main graphics library
...
- See `../include/zunegfx.h` for complete API documentation
