/*
    ...
    ZuneGfx Library - Text Demo (Unlocked DrawingBoard)

    Tests text functions with standard rastport operations:
    - ZuneSetFont
    - ZuneTextLength
    - ZuneTextFit
    ...
    Usage: demo_text_unlocked [cybergfx|opengl]
*/
...
int main(int argc, char **argv)
{
    ...
    printf("Text Demo (Unlocked) - %s\n", DemoBackendName(backend));
    printf("======================================\n\n");

    if (!DemoInit(&ctx, "Text Demo (Unlocked)", 800, 480, backend, 0))
        return 1;
