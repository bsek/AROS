/*
    ...
    ZuneGfx Library - Rectangle Demo (Unlocked DrawingBoard)

    Tests all non-AA rectangle functions with standard rastport operations:
    ...
    Usage: demo_rect_unlocked [cybergfx|opengl]
*/
