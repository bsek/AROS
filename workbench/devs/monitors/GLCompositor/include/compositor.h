...
/*
    ...
    OpenGL GPU Compositor - Uses same HIDD interface as software Compositor
*/
...
/*
 * Compositor interface - identical to software Compositor.
 * graphics.library recognizes this class by its name.
 */
...
/* Compositor class attributes */
enum
{
    aoHidd_Compositor_GfxHidd = 0,  /* [I..] Gfx driver object  */
    aoHidd_Compositor_DisplayID,    /* [I.G] Card ID part        */
    aoHidd_Compositor_Capabilities, /* [..G] Supported features  */
    aoHidd_Compositor_State,        /* [ISG] Active features     */
    aoHidd_Compositor_BackFillHook, /* [ISG] Void space hook     */
    aoHidd_Compositor_FrameBuffer,  /* [I..] Driver framebuffer  */
