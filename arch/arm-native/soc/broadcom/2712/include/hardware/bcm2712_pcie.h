 ...
 * share only the rescal and reset blocks below.
 *
 * The block is the size the device tree declares for the node; the indexed
 * configuration window at the top of it is the last thing in it, and there
 * is no ECAM anywhere.
 */
